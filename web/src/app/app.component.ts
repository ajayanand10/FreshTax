    ...
    ngOnInit() {
        this.items = [
            ...
            { label: 'Entities', icon: 'fa-search', items: [
                    {label: 'InvGstr1 Search', routerLink: ['/invGstr1-list']},
                    {label: 'InvGstr1 Create', routerLink: ['/invGstr1/new']},
                    {label: 'InvItemGstr1 Search', routerLink: ['/invItemGstr1-list']},
                    {label: 'InvItemGstr1 Create', routerLink: ['/invItemGstr1/new']},
